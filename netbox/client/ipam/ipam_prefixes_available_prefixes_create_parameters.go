...
type IpamPrefixesAvailablePrefixesCreateParams struct {
	...
	/*Data*/
	Data *models.WritableAvailablePrefix
	/*ID
...
func (o *IpamPrefixesAvailablePrefixesCreateParams) WithData(data *models.WritableAvailablePrefix) *IpamPrefixesAvailablePrefixesCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the ipam prefixes available prefixes create params
func (o *IpamPrefixesAvailablePrefixesCreateParams) SetData(data *models.WritableAvailablePrefix) {
	o.Data = data
}
